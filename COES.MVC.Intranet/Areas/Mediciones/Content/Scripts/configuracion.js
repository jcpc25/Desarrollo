...
actualizar = function ()
{
    if (confirm('¿Está seguro de actualizar el tipo de grupo?')) {
        $.ajax({
            ...
            dataType: 'json',
            data: { idGrupo: $('#hfIdGrupo').val(), idTipoGrupo: $('#cbEditTipoGrupo').val() },
            cache: false,
...
editarRegistro = function (idGrupo, emprnomb, gruponomb, grupoabrev, idtipogrupo)
{
    $.ajax({
        type: 'POST',
        ...
        data: {
            ...
            grupoAbrev: grupoabrev, idTipoGrupo: idtipogrupo
        },
        success: function (evt) {
