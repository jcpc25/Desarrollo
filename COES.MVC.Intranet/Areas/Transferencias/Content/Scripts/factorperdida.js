var factor = "factorperdida/";
var controler = siteRoot + "transferencias/" + factor;
var series = [];
var seriesB = [];
var labels = [];
...
procesarArchivo = function (sFile, sPericodi) {
    ...
    $.ajax({
        ...
        data: { sNombreArchivo: sFile, sPericodi: sPericodi, dValorMax: ValorMax },
        dataType: 'json',
        cache: false,
