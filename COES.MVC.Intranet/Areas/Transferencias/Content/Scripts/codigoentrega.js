...
function buscar() {
    ...
    $.ajax({
        type: 'POST',
        url: controler + "lista",
        data: { nombreEmp: $("#EMPRCODI option:selected").text(), centralGene: $("#CENTGENECODI option:selected").text(), nombreBarra: $("#BARRCODI option:selected").text(), fechaInicio: $('#txtfechaIni').val(), fechaFin: $('#txtfechaFin').val(), estado: estado },
