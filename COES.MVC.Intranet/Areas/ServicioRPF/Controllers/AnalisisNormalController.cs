...
{
    public class AnalisisNormalController : Controller
    {
        /// <summary>
        ...
        public PartialViewResult SeleccionRango(string fecha)
        {
            ...
            List<ServicioRpfDTO> listConfiguracion = this.logic.ObtenerUnidadesCarga();
        ...
        public JsonResult GenerarWord(string fecha)
        {
            ...
            try
            {
                ...
                List<ServicioRpfDTO> listTotal = this.logic.ObtenerUnidadesCarga();
        ...
        public JsonResult GrabarParametro(decimal estatismo, decimal rPrimaria, decimal frecNominal, decimal porCumplimiento,
            decimal varPotencia, decimal varFrecuencia, decimal intentos, decimal cantidad, decimal banda, int nroDatos)
        {
            try
            {
