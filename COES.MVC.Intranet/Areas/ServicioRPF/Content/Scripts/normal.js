...
{
    if ($('#txtEstatismo').val() == "" || $('#txtRPrimaria').val() == "" || $('#txtFrecNominal').val() == "" ||
       $('#txtPorCumplimiento').val() == "" || $('#txtVarPotencia').val() == "" || $('#txtVarFrecuencia').val() == ""
        || $('#txtNroIntentos').val() == "" || $('#txtSinRango').val() == "" || $('#txtBanda').val() == "" || $('#txtNroDatos').val() == "") {
        ...
        $.ajax({
            ...
            data: {
                estatismo: $('#txtEstatismo').val(), rPrimaria: $('#txtRPrimaria').val(), frecNominal: $('#txtFrecNominal').val(),
                porCumplimiento: $('#txtPorCumplimiento').val(), varPotencia: $('#txtVarPotencia').val(), varFrecuencia: $('#txtVarFrecuencia').val(),
                intentos: $('#txtNroIntentos').val(), cantidad: $('#txtSinRango').val(), banda: $('#txtBanda').val(), nroDatos: $('#txtNroDatos').val()
            },
            dataType: 'json',
            cache: false,
            success: function (result) {
