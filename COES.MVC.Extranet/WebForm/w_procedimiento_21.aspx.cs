...
namespace WSIC2010
{
    public partial class w_procedimiento_21 : System.Web.UI.Page
    {
        ...
        protected void CargarDatos()
        {
            ...
            string page = String.Format("<iframe  id='frameContenido' src='http://coesextranet.azurewebsites.net/{1}/{2}?user={0}' width='100%' height='900' scrolling='auto' style='border:1px none'></iframe>",
