...
namespace COES.Infraestructura.Datos.Respositorio.Sic
{
    ...
    public class MeMedidorRepository: RepositoryBase, IMeMedidorRepository
    {
        ...
        public int Save(MeMedidorDTO entity)
        {
            ...
            dbProvider.AddInParameter(command, helper.Medimarca, DbType.String, entity.Medimarca);
            dbProvider.AddInParameter(command, helper.Medimodelo, DbType.String, entity.Medimodelo);
            dbProvider.AddInParameter(command, helper.Medinserie, DbType.String, entity.Medinserie);
            dbProvider.AddInParameter(command, helper.Medicprecision, DbType.String, entity.Medicprecision);
