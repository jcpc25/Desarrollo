...
namespace COES.Infraestructura.Datos.Respositorio.Sic
{
    ...
    public class MePerfilRuleRepository: RepositoryBase, IMePerfilRuleRepository
    {
        ...
        public List<MePerfilRuleDTO> GetByCriteria(int area, string fuente)
        {
            List<MePerfilRuleDTO> entitys = new List<MePerfilRuleDTO>();
            DbCommand command = dbProvider.GetSqlStringCommand(helper.SqlGetByCriteria);

            dbProvider.AddInParameter(command, helper.Prruind, DbType.String, fuente);
            dbProvider.AddInParameter(command, helper.Areacodi, DbType.Int32, area);            
