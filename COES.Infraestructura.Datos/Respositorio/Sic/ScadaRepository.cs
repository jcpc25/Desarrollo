...
namespace COES.Infraestructura.Datos.Respositorio.Sic
{
    public class ScadaRepository: RepositoryBase
    {
        ...
        public List<ScadaDTO> ObtenerConsultaScada(string filtro, DateTime fechaInicio, DateTime fechaFin)
        {
        ...
        public List<PerfilScadaDTO> ListarPerfilesPorUsuario(string username, DateTime inicio, DateTime fin, string fuente)
        {
            ...
            string query = String.Format(helper.SqlBuscarPerfiles, username, inicio.ToString(ConstantesBase.FormatoFecha),
                fin.ToString(ConstantesBase.FormatoFecha), fuente);
            DbCommand command = dbProvider.GetSqlStringCommand(query);
        ...
        public List<PerfilScadaDTO> ObtenerPerfilesExportacion(string username, int areaCode, string fuente)
        {
            ...
            string query = String.Format(this.helper.SqlObtenerExportacion, username, areaCode, fuente);
            DbCommand command = dbProvider.GetSqlStringCommand(query);
