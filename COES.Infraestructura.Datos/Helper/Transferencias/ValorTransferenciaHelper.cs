...
namespace COES.Infraestructura.Datos.Helper.Transferencias
{
    ...
    {
        public ValorTransferenciaHelper() : base(Consultas.ValorTransferenciaSql)
        {
        }
        ...
        public ValorTransferenciaDTO Create(IDataReader dr)
        {
            ...
            if (!dr.IsDBNull(iValoTranCodi)) entity.ValoTranCodi = dr.GetInt32(iValoTranCodi);
            ...
            int iNombEmpresa = dr.GetOrdinal(this.NombEmpresa);
            ...
            int iRetiros = dr.GetOrdinal(this.Retiros);
            if (!dr.IsDBNull(iRetiros)) entity.retiros = dr.GetDecimal(iRetiros);

            int iNeto = dr.GetOrdinal(this.Neto);
        ...
        public string SqlCodigoGenerado
        {
         ...
         public string SqlGetBalance
         {
             get { return base.GetSqlXml("GetBalance"); }
         }
    }
}
