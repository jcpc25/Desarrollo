...
namespace COES.Infraestructura.Datos.Helper.Sic
{
    public class ScadaHelper: HelperBase
    {
        ...
        public ScadaDTO Create(IDataReader dr)
        {
            ...
            if (!dr.IsDBNull(iCanalCodi)) entity.CANALCODI = Convert.ToInt16(dr.GetValue(iCanalCodi));

            int iPtoMediCodi = dr.GetOrdinal(this.PTOMEDICODI);
            if (!dr.IsDBNull(iPtoMediCodi)) entity.PTOMEDICODI = Convert.ToInt16(dr.GetValue(iPtoMediCodi));
