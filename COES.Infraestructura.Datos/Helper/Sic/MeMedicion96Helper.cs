...
namespace COES.Infraestructura.Datos.Helper.Sic
{
    public class MeMedicion96Helper : HelperBase
    {
        ...
        public string SqlObtenerExportacionMasivaMedidores
        {
            get { return base.GetSqlXml("ObtenerExportacionMasivaMedidores"); }
        }

        public string SqlObtenerExportacionMasivaSSAA
        {
            get { return base.GetSqlXml("ObtenerExportacionMasivaSSAA"); }
        }
